...
code .comment {
  ...
  button {
    ...
    background-image: linear-gradient(to right, #049cdb, #0064cd);
    color: #fff;
  ...
  table th {
    ...
    // background-image: -webkit-linear-gradient(to right, #ebf3fc, #dce9f9);
    // background-image: -moz-linear-gradient(top, #ebf3fc, #dce9f9);
    // background-image: -ms-linear-gradient(top, #ebf3fc, #dce9f9);
    // background-image: -o-linear-gradient(top, #ebf3fc, #dce9f9);
    background-image: linear-gradient(to right, #ebf3fc, #dce9f9);
